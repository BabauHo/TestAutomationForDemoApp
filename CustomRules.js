...
class Handlers
{
    ...
    */
    ...
    static function OnBeforeRequest(oSession: Session) {
		...
		// For in2w demo
		if(oSession.host == "postman-echo.com"){
			if(oSession.url.indexOf("start") !== -1){
				oSession.utilDecodeRequest();
				oSession.SaveRequest("C:\\Users\\BaBau\\Desktop\\work\\anyCode\\in2w\\vedio_start.txt",true);
				oSession.SaveRequestBody("C:\\Users\\BaBau\\Desktop\\work\\anyCode\\in2w\\vedio_start_body.txt");
			} else if(oSession.url.indexOf("1qr") !== -1){
				oSession.utilDecodeRequest();
				oSession.SaveRequest("C:\\Users\\BaBau\\Desktop\\work\\anyCode\\in2w\\vedio_1qr.txt",true);
				oSession.SaveRequestBody("C:\\Users\\BaBau\\Desktop\\work\\anyCode\\in2w\\vedio_1qr_body.txt");
			} else if(oSession.url.indexOf("2qr") !== -1){
				oSession.utilDecodeRequest();
				oSession.SaveRequest("C:\\Users\\BaBau\\Desktop\\work\\anyCode\\in2w\\vedio_2qr.txt",true);
				oSession.SaveRequestBody("C:\\Users\\BaBau\\Desktop\\work\\anyCode\\in2w\\vedio_2qr_body.txt");
			} else if(oSession.url.indexOf("3qr") !== -1){
				oSession.utilDecodeRequest();
				oSession.SaveRequest("C:\\Users\\BaBau\\Desktop\\work\\anyCode\\in2w\\vedio_3qr.txt",true);
				oSession.SaveRequestBody("C:\\Users\\BaBau\\Desktop\\work\\anyCode\\in2w\\vedio_3qr_body.txt");
			} else if(oSession.url.indexOf("complete") !== -1){
				oSession.utilDecodeRequest();
				oSession.SaveRequest("C:\\Users\\BaBau\\Desktop\\work\\anyCode\\in2w\\vedio_complete.txt",true);
				oSession.SaveRequestBody("C:\\Users\\BaBau\\Desktop\\work\\anyCode\\in2w\\vedio_complete_body.txt");
			} else if(oSession.url.indexOf("unmute") !== -1){
				oSession.utilDecodeRequest();
				oSession.SaveRequest("C:\\Users\\BaBau\\Desktop\\work\\anyCode\\in2w\\vedio_unmute.txt",true);
				oSession.SaveRequestBody("C:\\Users\\BaBau\\Desktop\\work\\anyCode\\in2w\\vedio_unmute_body.txt");
			} else if(oSession.url.indexOf("click") !== -1){
				oSession.utilDecodeRequest();
				oSession.SaveRequest("C:\\Users\\BaBau\\Desktop\\work\\anyCode\\in2w\\vedio_click.txt",true);
				oSession.SaveRequestBody("C:\\Users\\BaBau\\Desktop\\work\\anyCode\\in2w\\vedio_click_body.txt");
			} else if(oSession.url.indexOf("mute") !== -1){
				oSession.utilDecodeRequest();
				oSession.SaveRequest("C:\\Users\\BaBau\\Desktop\\work\\anyCode\\in2w\\vedio_mute.txt",true);
				oSession.SaveRequestBody("C:\\Users\\BaBau\\Desktop\\work\\anyCode\\in2w\\vedio_mute_body.txt");
			} else if(oSession.url.indexOf("impression") !== -1){
				oSession.utilDecodeRequest();
				oSession.SaveRequest("C:\\Users\\BaBau\\Desktop\\work\\anyCode\\in2w\\vedio_impression.txt",true);
				oSession.SaveRequestBody("C:\\Users\\BaBau\\Desktop\\work\\anyCode\\in2w\\vedio_impression_body.txt");
			}
		}
